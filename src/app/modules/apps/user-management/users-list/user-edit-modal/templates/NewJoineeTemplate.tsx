...
export const getNewJoineeTemplate = (
  user: UserData,
  salary: SalaryData,
    ...
    <div class="salary-container">
      <div class="salary-box">
        ...
        <table class="table-section">
          <thead><tr><th>Description</th><th>Amount (SAR)</th></tr></thead>
          <tbody>
      ...
      <div class="salary-box">
        ...
        <table class="table-section">
          ...
          <tbody>
            ...
            <tr>
              <td colspan="2">
                <div style="display:flex;justify-content:flex-start;gap:31px;">
                  <span>New Joinee Deductions</span>
                  <span>${formatNumber(salary.lop_salary_total)}</span>
                </div>
                <div style="display:flex;justify-content:flex-start;margin-left:57%;">
                  <p class="verySmall">Deduction as per joining date</p>
                </div>
              </td>
            </tr>
