...
import { getAllEmployees } from '../../../../../apiFactory/apiHelper';
const [employees, setEmployees] = useState([]);

let apiData = {}
useEffect(() => 
  {
    apiData = getAllEmployees().then(function(data) {apiData = data})
  },[])
  ...
  return (
    <div className='w-100'>
      <div className='pb-10 pb-lg-15'>
        <h2 className='fw-bolder text-gray-900'>Expense Info</h2>
        <div className='text-gray-500 fw-bold fs-6'>
          If you need more info, please check with
          <a href='tel:+966505426075' className='link-primary fw-bolder'>
            {' '}
            ERP Support
          </a>
          .
      ...
      <div className='mb-10'>
          ...
          <div className='d-flex'>
            <label className='form-check form-check-sm form-check-custom form-check-solid me-5'>
              ...
              <span className='form-check-label'>New Employee</span>
            </label>

            <label className='form-check form-check-sm form-check-custom form-check-solid'>
              <input className='form-check-input' type='checkbox' value='2' defaultChecked={true} />
              <span className='form-check-label'>Existing Employee</span>
            </label>
          </div>
        </div>
      <div>
