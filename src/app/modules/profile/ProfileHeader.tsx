...
import { UsersQueryResponse } from "../apps/user-management/users-list/core/_models";

var userInfo: any = await apiHelper.getEmployeeInfo("1").then((data) => {
  return data;
});

var salaryInfo: any = await apiHelper
  .getEmployeeSalaryInfo("1")
  .then((data) => {
    return data;
  });

var billingInfo: any = await apiHelper
  .getEmployeeBillingInfo("1")
  .then((data) => {
    return data;
  });

var profitRate =
  (salaryInfo.data[0].total_net_salary /
    (billingInfo.data[0].billing_value / billingInfo.data[0].billing_months)) *
  100;
