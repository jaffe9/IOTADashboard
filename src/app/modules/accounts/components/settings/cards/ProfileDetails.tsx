          ...
          <div className='card-body border-top p-9'>
              ...
              <div className='col-lg-8'>
                ...
                >
                  <div
                    ...
                    style={{backgroundImage: `url(${toAbsoluteUrl(data.fName)})`}}
                  ></div>
                </div>
              </div>
            </div>
            ...
            <div className='row mb-6'>
              ...
              <div className='col-lg-8 fv-row'>
                ...
                {formik.touched.client && formik.errors.client && (
                  <div className='fv-plugins-message-container'>
                    <div className='fv-help-block'>{formik.errors.client}</div>
                  </div>
                )}
              </div>
            </div>
            ...
            <div className='row mb-6'>
              ...
              <div className='col-lg-8 fv-row'>
                ...
                />
                {formik.touched.communications?.phone && formik.errors.communications?.phone && (
                  <div className='fv-plugins-message-container'>
                    <div className='fv-help-block'>{formik.errors.communications?.phone}</div>
                  </div>
                )}
              </div>
            </div>
