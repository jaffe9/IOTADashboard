...
const [selectedEmployee, setSelectedEmployee] = useState(allUserInfo)
...
const EmployeeTimesheet: FC = () => {
  const [data, setData] = useState<IProfileDetails>(allUserInfo);
  const updateData = (fieldsToUpdate: Partial<IProfileDetails>): void => {
    const updatedData = Object.assign(allUserInfo, fieldsToUpdate);
    setData(updatedData);
  };
                    ...
                    <div className="col-lg-8 d-flex align-items-center">
                      <div className="form-check form-check-solid form-switch fv-row">
                        <input
                          ...
                          type="checkbox"
                          id="allowmarketing"
                          defaultChecked={data.loadDefault}
                          onChange={() => {
                            updateData({
                              loadDefault: !data.loadDefault,
                            });
                          }}
                        />
