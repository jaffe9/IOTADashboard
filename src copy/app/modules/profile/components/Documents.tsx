...
var userInfo: any = await apiHelper
  .getEmployeeInfo("1")
  .then((data) => {
  return data;
});

var invoiceInfo: any = await apiHelper
  .getEmployeeInvoiceInfo("1")
  .then((data) => {
    return data;
  });
    ...
    <Content>
      <div className="d-flex flex-wrap flex-stack mb-6">
        <h3 className="fw-bolder my-2">
          {userInfo.data[0]?.first_name}'s Documents
      ...
      <div className="row g-6 g-xl-9 mb-6 mb-xl-9">
        ...
        <div className="col-12 col-sm-12 col-xl">
          <Card4
            icon="media/svg/files/folder-document.svg"
            title="Invoices"
            description={invoiceInfo.data.length + " files"}
          />
        </div>
      </div>
